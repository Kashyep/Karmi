...
> and L-1..L-7, L-9 in #7. M-3 (stale lock) and M-4 (delivery worker, test adapter only) fixed 2026-09-26. Re-verify any item against the code before acting on it.
