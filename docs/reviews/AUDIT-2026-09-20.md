...
> **Status (2026-09-26):** historical snapshot of `a04700c`. Most C/H/M findings were fixed in
> PRs #3–#5. Known still open: M-3 (`requirements.lock` carries unused packages), M-4 (no outbox
